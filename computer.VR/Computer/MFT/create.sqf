...
if( count _this isEqualTo 5 ) then {
	_workingFolder = [_computer] call Computer_MFT_WorkingFolder;
	_oldWorkingFolder = _workingFolder;
	_workingIndex = _workingFolder select 1;
	_directPath = _this select 4;
	[ _computer, [_directPath] call Computer_MFT_PathToArray ] call Computer_MFT_ChangeWorkingFolder;
	...
	_computer setVariable [ "Computer_WorkingFolder" , _oldWorkingFolder , false ];
};
